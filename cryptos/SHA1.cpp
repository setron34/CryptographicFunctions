...
public:
	static char* EvaluateMethod1(char* inputString, uint64_t inputLen) {
		...
		uint32_t* K = new uint32_t[80]{ 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 0x5A827999, 
...
private:
	...
	static inline uint32_t f(uint8_t t, uint32_t B, uint32_t C, uint32_t D) { //f(t;B,C,D) = (B AND C) OR ((NOT B) AND D),          ( 0 <= t <= 19)
